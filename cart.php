...
<div id="row same-height-row">
  ...
  <div class="d-3">
    <div class="product same-height">
      <a href="">
        <img src="website/product_images/gift1.jpg"width="80"  class="img-responsive">
      </a>
      <div class="tet">
  ...
  <div class="d-3">
    <div class="product same-height">
      <a href="">
        <img src="website/product_images/gift2.webp" width="80" class="img-responsive">
      </a>
      <div class="tet">
        <h3><a href="details.php"></a></h3>
        <p class="price"><i class="fa fa-inr"></i>200</p>
      </div>
    </div>
  </div>
  ...
  <div class="d-3">
    <div class="product same-height">
      <a href="">
        <img src="website/product_images/cake1.webp" width="80" class="img-responsive">
      </a>
      <div class="tet">
        <h3><a href="details.php"></a></h3>
        <p class="price"><i class="fa fa-inr"></i>100</p>
      </div>
    </div>
  </div>
   <div class="d-3">
    <div class="product same-height">
      <a href="">
        <img src="website/product_images/gift6.jpg"width="80"  class="img-responsive">
      </a>
      <div class="tet">
        <h3><a href="details.php"></a></h3>
        <p class="price"><i class="fa fa-inr"></i>150</p>
      </div>
    </div>
  </div>
   <div class="d-3">
    <div class="product same-height">
      <a href="">
        <img src="website/product_images/gift3.jpg" width="80" class="img-responsive">
      </a>
      <div class="tet">
        <h3><a href="details.php"></a></h3>
        <p class="price"><i class="fa fa-inr"></i>120</p>
      </div>
    </div>
  </div>
</div>
