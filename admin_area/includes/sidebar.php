...
<nav class="navbar navbar-inverse navbar-fixed-top" >
    ...
    <a href="index.php?user_profile?id=<?php echo $admin_id ?>"><i class=""></i>Profile</a>
    <a href="index.php?view_product"><i class=""></i>Products

     <span class="badge"><?php echo $count_pro ?></span></a>


    <a href="index.php?view_customer"><i class=""></i>Customer 
      <span class="badge"><?php echo $count_cust ?></span></a>
    </a>
    <a href="index.php?pro_cat"><i class=""></i>Product Categories
        <span class="badge"><?php echo $count_p_cat ?></span></a>
    </a>
   
    <a class="divider" href="logout.php"> Logout <i class=""></i></a>
  ...
  <li>
    <a href="index.php?dashboard"><i class=""></i> Dashboard</a>
  </li>
  <li class="button-dropdown" id="#products">
    <a href="#" class="dropdown-toggle" data-toggle="collapse" data-target="#products"><i class=""></i> Product <i class=""></i></a>
  ...
  <li class="button-dropdown" id="#products_cat">
    <a href="#" class="dropdown-toggle" data-toggle="collapse" data-target="#products_cat"><i class=""></i> Product Categories <i class=""></i></a>
  ...
  <li class="button-dropdown" id="#category">
    <a href="#" class="dropdown-toggle" data-toggle="collapse" data-target="#category"><i class=""></i> Categories <i class=""></i></a>
...
<li class="button-dropdown" >
  <a href="#" class="dropdown-toggle" data-toggle="collapse" data-target="#boxes">
    <i class=""></i> Boxes Section <i class=""></i>
  </a>
  ...
  <li class="button-dropdown">
    <a href="#" class="dropdown-toggle" data-toggle="collapse" data-target="#slider"><i class=""></i>  Slider <i class=""></i></a>
  ...
  <li>
  	<a href="index.php?view_customer">
  		<i class=""></i> View Customer
  	</a>
  </li>
  <li>
  	<a href="index.php?view_order">
  		<i class=""></i> View Order
  	</a>
  </li>
  <li>
  	<a href="index.php?view_payments">
  		<i class=""></i> View Payments
  	</a>
  </li>
  <li class="button-dropdown">
